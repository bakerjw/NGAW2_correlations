function [rho] = ga_09_correlation(T1, T2)
...
% coefficients from the bottom of page 3009
theta1 = 1.374;
theta2 = 5.586;
theta3 = 0.728;
...
for i = 1:length(T1)
    for j = 1:length(T2)
        ...
        if T_max > 5 || T_min < 0.1 % limits based on plot limits of figure 6
           ...
           if rho(i,j) > 1
               rho(i,j) = 1; % prevent too high of prediction (per 5/18/2016 discussion with Goda, this was unintended)
           end
        end
    end
end
